...
//
//		// Traverse the Maze
//		boolean hashPathBFS = solver.hasPath(1, 30);
//		System.out.println("STATE: " + hashPathBFS);
//		System.out
...
//	}
//	@Test
//	public void testPathExist4() throws IOException {
//		MazeSolver<Integer> solver = new MazeSolver<Integer>();
//		String expectedPath = "1 3 6 9 30 21";
//		solver = this.makeTestMap(solver);
//		System.out.println("\nPrinting Graph...");
//		System.out.println(solver.getNodeMap());
//
//		// Traverse the Maze
//		boolean hashPathBFS = solver.hasPath(1, 21);
//		System.out.println("STATE: " + hashPathBFS);
//		System.out
//				.println(hashPathBFS ? "Path Exist " + 1 + " " + 21 + " " : "Path does not exist " + 1 + " " + 21 + " ");
//
//		String shortPath = solver.findPath(1, 21);
//		assertEquals(expectedPath, shortPath);
//
//	}
//
